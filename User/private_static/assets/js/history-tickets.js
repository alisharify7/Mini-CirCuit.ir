...
function ShowModalTicket(data) {
    ...
    AttachmentFile.textContent = data.attachment ? "دانلود" : "ندارد"
    if(AttachmentFile.textContent == "دانلود"){
        AttachmentFile.href = data.attachment;
        if(AttachmentFile.classList.contains("d-none")){
            AttachmentFile.classList.remove("d-none");
        }
