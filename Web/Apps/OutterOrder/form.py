...
class RegisterOrderAboardForm(FlaskForm):
    ...
    Name = StringField(
        ...
        validators=[
            Length(
                min=1, max=512, message="حداقل و حداکثر طول این فیلد 1-512 کاراکتر است"
            ),
    ...
    Quantity = IntegerField(
        ...
        validators=[
            NumberRange(
                min=1,
                max=10000,
                message="حداقل تعداد سفارش 1 و حداکثر 10000 سفارش می باشد",
            ),
            DataRequired(message="ورود داده در این فیلد الزامی است"),
            InputRequired(message="ورود داده در این فیلد الزامی است"),
        ],
    ...
    Description = TextAreaField(
        ...
        validators=[
            Length(
                min=1,
                max=4096,
                message="حداقل و حداکثر تعداد ورودی در این فرم 1-4096 کاراکتر می باشد",
            ),
            DataRequired(message="ورود داده در این فیلد الزامی است"),
            InputRequired(message="ورود داده در این فیلد الزامی است"),
        ],
    ...
    Submit = SubmitField(
        render_kw={"class": "btn btn-primary w-100 fs-5", "value": "ثبت سفارش"}
    )
